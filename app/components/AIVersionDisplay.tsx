...
export default function AIVersionDisplay() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 text-[10px] text-gray-500 bg-black/80 px-3 py-1.5 rounded-full border border-gray-800 backdrop-blur-sm flex items-center gap-2 shadow-lg hover:bg-black/90 transition-colors cursor-help group">
